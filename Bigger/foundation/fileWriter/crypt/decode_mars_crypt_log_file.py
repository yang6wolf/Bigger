...
PRIV_KEY = "08de52132efff306b3f7f20dfae2e2f4b173bf80aa728ec178c42f2244ddf9c5"
PUB_KEY = "c6909c84d9099761b8e7dd91615492b81fc1f81df563ad208564ba304d94f0146d10d7cc163de76fa8ecc3c0696444e855ec0fa68c05f00c84b49e18abe67c19"
...
def ParseFile(_file, _outfile):
    ...
    utf8_str = ['\xEF', '\xBB', '\xBF']
    for item in utf8_str:
        fpout.write(item)
...
def main(args):
    ...
    if 1==len(args):
        if os.path.isdir(args[0]):
            filelist = glob.glob(args[0] + "/*.plog")
